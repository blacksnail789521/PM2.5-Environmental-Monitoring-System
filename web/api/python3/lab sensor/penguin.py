...
if __name__ == "__main__":
    ...
    number_of_motifs = 3
    lower_limit_of_the_number_of_single_motif = 5
    ...
    for single_query_length in query_length:
        ...
        '''
        with open("data/matrix_profile.csv", 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
            for element in matrix_profile:
                writer.writerow([element])
                
        with open("data/matrix_profile_index.csv", 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
            for element in matrix_profile_index:
                writer.writerow([element])
            
        with open("data/motif_index.csv", 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
            for element in motif_index:
                writer.writerow([element])
                
        with open("data/discord_index.csv", 'w', newline='') as csvfile:
            writer = csv.writer(csvfile)
